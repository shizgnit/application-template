...
spatial::vector::vector(float x, float y, float z, float w) {
    this->x = x;
    this->y = y;
    this->z = z;
    this->w = w;
...
spatial::vector& spatial::vector::rotate_x(float rad) {
    vector result;
...
spatial::vector spatial::vector::rotate_y(float rad) {
    vector result;
...
spatial::vector spatial::vector::rotate_z(float rad) {
    vector result;
...
float spatial::vector::dot() {
    return(x * x + y * y + z * z);
}

float spatial::vector::length() {
...
spatial::matrix& spatial::matrix::scale(const float& operand) {
    return(*this *= operand);
}
spatial::matrix& spatial::matrix::operator *= (const float& operand) {
    return (*this = (*this) * operand);
}
spatial::matrix spatial::matrix::operator * (const float& operand) const {
    matrix result = *this;
...
spatial::matrix& spatial::matrix::rotate_x(float angle) {
    matrix rotation;
...
spatial::matrix& spatial::matrix::rotate_y(float angle) {
    matrix rotation;
...
spatial::matrix& spatial::matrix::rotate_z(float angle) {
    matrix rotation;
...
spatial::matrix& spatial::matrix::translate(const float& x, const float& y, const float& z, const float& w) {
    matrix current = *this;
...
spatial::matrix& spatial::matrix::perspective(float fov, float aspect, float n, float f) {
...
spatial::matrix& spatial::matrix::ortho(float left, float right, float bottom, float top) {
...
void spatial::position::vertical(float t) {
    vector diff = up * t;
